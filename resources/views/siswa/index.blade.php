...
<!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>
        Siswa
        <small>SMK BINA TARUNA SUBANG</small>
      </h1>
      <ol class="breadcrumb">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><a href='{{ url("siswa/$row->nis/edit") }}' class="btn btn-sm btn-warning"><i class="fa fa-pencil"></i></a>
                  <form action='{{ url("siswa/$row->nis/delete") }}' method="GET" style="display:inline;"> 

                    <!-- Jika Pakai GET di routes/web.php "delete" ganti jadi get -->
